...
script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCLsgBkf2kPSWIYMK0fU7VFxf1p-5Rexi8&callback=initMap';
script.defer = true;
...
const searchStores = () => {
  let foundStores = [];
  let postalCode = document.getElementById('zipcode-input').value;
  if (postalCode) {
